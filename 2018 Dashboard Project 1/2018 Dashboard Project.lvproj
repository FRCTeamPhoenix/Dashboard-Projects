...
<Project Type="Project" LVVersion="17008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Support" Type="Folder">
			...
			<Item Name="FRC Color Processing.vi" Type="VI" URL="../FRC Color Processing Example Folder/FRC Color Processing.vi"/>
			<Item Name="Variable Graphing.vi" Type="VI" URL="../Variable Graphing.vi"/>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Camera Types.ctl" Type="VI" URL="../FRC Color Processing Example Folder/Vision Support Code/Camera Types.ctl"/>
			<Item Name="niimaqdx.dll" Type="Document" URL="niimaqdx.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="Calibration Helper2.vi" Type="VI" URL="../FRC Color Processing Example Folder/Vision Support Code/Calibration Helper2.vi"/>
			<Item Name="Sorted Particle Report 2016.vi" Type="VI" URL="../FRC Color Processing Example Folder/Vision Support Code/Sorted Particle Report 2016.vi"/>
			<Item Name="Cull and Group.vi" Type="VI" URL="../FRC Color Processing Example Folder/Vision Support Code/Cull and Group.vi"/>
			<Item Name="Rectangle Comparison.vi" Type="VI" URL="../FRC Color Processing Example Folder/Vision Support Code/Rectangle Comparison.vi"/>
			<Item Name="Compute DistanceToTarget2.vi" Type="VI" URL="../FRC Color Processing Example Folder/Vision Support Code/Compute DistanceToTarget2.vi"/>
			<Item Name="Get camera FOVs.vi" Type="VI" URL="../FRC Color Processing Example Folder/Vision Support Code/Get camera FOVs.vi"/>
			<Item Name="Normalize Coordinates.vi" Type="VI" URL="../FRC Color Processing Example Folder/Vision Support Code/Normalize Coordinates.vi"/>
			<Item Name="Label Targets2.vi" Type="VI" URL="../FRC Color Processing Example Folder/Vision Support Code/Label Targets2.vi"/>
		</Item>
